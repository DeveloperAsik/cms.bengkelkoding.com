    ...
    return {
        ...
        init: function () {
            ...
            var table = $('#group_permissions').DataTable({
                ...
                "processing": true,
                "lengthChange": true,
                "lengthMenu": [[10, 25, 50, 100, 150, 200, 250, 500 - 1], [10, 25, 50, 100, 150, 200, 250, 500, 1000]],
                "language": {
                    processing: '<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span> '
                },
                "ajax": {
                    url: _base_extraweb_uri + '/profile/get-group-permission-list', //_base_extraweb_uri + '/profile/get-group-permission-list',
                    headers: {
