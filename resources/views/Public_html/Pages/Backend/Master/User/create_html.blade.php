                            ...
                            <div class="row">
                                <div class="col-5 col-sm-3">
                                    <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <a class="nav-link" id="vert-tabs-group-tab" data-toggle="pill" href="#vert-tabs-group" role="tab" aria-controls="vert-tabs-group" aria-selected="false">Group</a>
                                        <a class="nav-link" id="vert-tabs-permission-tab" data-toggle="pill" href="#vert-tabs-permission" role="tab" aria-controls="vert-tabs-permission" aria-selected="false">Permission</a>
                                ...
                                <div class="col-7 col-sm-9">
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="vert-tabs-group" role="tabpanel" aria-labelledby="vert-tabs-group-tab">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" id="group" name="group">
                                                            ...
                                                            <option value="{!! base64_encode($value->id) !!}">{{$value->name}}</option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="vert-tabs-permission" role="tabpanel" aria-labelledby="vert-tabs-permission-tab">
                                            <div class="card-body">
                                                <h2>Denied list User Permission</h2>
                                                <table style="width:100%;background-color:#fff;color:#000; font-size:10px;" class="table table-bordered" id="permissions">
                                                    <thead>
                                                        <tr role="row" class="heading">
                                                            ...
                                                            <th>Controller</th>
                                                            <th>Method</th>
                                                            <th style="text-align:center">check all<br/><input type="checkbox" name="checkall_permission" value="1" class="make-switch" data-size="small"></th>
                                                        </tr>							
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
                                        ...
                                        <div class="tab-pane fade" id="vert-tabs-menu" role="tabpanel" aria-labelledby="vert-tabs-menu-tab">
                                            <div class="card-body">
                                                <div class="portlet-body">
                                                    <h2>Denied list Menu Permission</h2>
