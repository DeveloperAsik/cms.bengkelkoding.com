    ...
    return {
        ...
        init: function () {
            ...
            var table = $('#permissions').DataTable({
                ...
                "ajax": {
                    url: _base_extraweb_uri + '/master/permission/get_list',
                    headers: {
            ...
            $('#permissions').on('click', 'input[type="checkbox"][name="is_basic"]', function () {
            ...
            $('#permissions').on('click', 'input[type="checkbox"][name="is_public"]', function () {
                loadingImg('img-loading', 'start');
                var checked = this.checked;
                var id = $(this).attr('data-id');
                var uri = _base_extraweb_uri + '/master/permission/update/' + id;
