                            ...
                            <div class="col-md-12">
                                <form class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="check" class="col-sm-2 control-label">Is Group Project</label>
                                            <div class="col-sm-10">
                                                @if($group['data']->is_group_project == 1)
                                                    @php $checked_group_project = ' checked'; @endphp
                                                @else
                                                    @php $checked_group_project = '';@endphp
                                                @endif
                                                <input type="checkbox" name="check" data-id="{{ base64_encode($group['data']->id)}}" value="is_group_project"{{$checked_group_project}}> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="check" class="col-sm-2 control-label">Is Menu</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="check" class="col-sm-2 control-label">Is Active</label>
                                            <div class="col-sm-10">
