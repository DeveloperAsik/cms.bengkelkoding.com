...
<html>
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{config('app.base_static_uri') .'/images/logo-orenocms.png'}}">
        @include('Public_html.Layouts.Adminlte.Includes.dashboard.include_meta')
        @include('Public_html.Layouts.Adminlte.Includes.calendar.include_css')
    </head>
    <body class="hold-transition sidebar-mini" {{$default_layout}}">
        ...
        <!-- ./wrapper -->
        @include('Public_html.Layouts.Adminlte.Includes.calendar.include_js')
    </body>
</html>
