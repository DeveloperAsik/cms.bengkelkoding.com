...
<script src="{{config('app.base_assets_uri')}}/templates/adminlte/plugins/fullcalendar/main.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/adminlte/plugins/fullcalendar-daygrid/main.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/adminlte/plugins/fullcalendar-timegrid/main.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/adminlte/plugins/fullcalendar-interaction/main.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/adminlte/plugins/fullcalendar-bootstrap/main.min.js"></script>
...
@if (isset($load_js) && !empty($load_js))
    @foreach ($load_js AS $key => $values)
        <script src="{{config('app.base_static_uri')}}/{{$values}}" type="text/javascript"></script>
    @endforeach;
@endif
