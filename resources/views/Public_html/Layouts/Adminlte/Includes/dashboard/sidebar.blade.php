<aside class="main-sidebar sidebar-light elevation-4 sidebar-light-lime">
    <!-- Brand Logo -->
    <a href="{{config('app.base_extraweb_uri') .'/dashboard'}}" class="brand-link" style="font-size:1em !important">
        <img src="{{config('app.base_assets_uri') .'/images/logo-orenocms.png'}}"
             alt="AdminLTE Logo"
             class="brand-image img-circle elevation-4"
             style="opacity: .8">
        <span class="brand-text font-weight-light" style="padding-left:0px">{{config('app.name')}}</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item{{ (isset($val1->is_open) && $val1->is_open == 1 ? ' menu-is-opening menu-open' : '') }}">
                    ...
                    <a href="{{config('app.base_extraweb_uri') . $val1->path}}" target="_blank" style="position: relative;float: right;right: 30px;top: 10px; z-index:99999"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                    @endif
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item{{ (isset($val2->is_open) && $val2->is_open == 1 ? ' menu-is-opening menu-open' : '') }}">
                            ...
                            <a href="{{config('app.base_extraweb_uri') . $val2->path}}" target="_blank" style="position: relative;float: right;right: 30px;top: 10px;z-index:99999"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                            @endif
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item{{ (isset($val3->is_open) && $val3->is_open == 1 ? ' menu-is-opening menu-open' : '') }}">
                                    ...
                                    <a href="{{config('app.base_extraweb_uri') . $val3->path}}" target="_blank" style="position: relative;float: right;right: 30px;top: 10px;z-index:99999"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                                    @endif
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item{{ (isset($val4->is_open) && $val4->is_open == 1 ? ' menu-is-opening menu-open' : '') }}">
                                            ...
                                            <a href="{{config('app.base_extraweb_uri') . $val4->path}}" target="_blank" style="position: relative;float: right;right: 30px;top: 10px;z-index:99999"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                                            @endif
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item{{ (isset($val5->is_open) && $val5->is_open == 1 ? ' menu-is-opening menu-open' : '') }}">
                                                    ...
                                                    <a href="{{config('app.base_extraweb_uri') . $val5->path}}" target="_blank" style="position: relative;float: right;right: 30px;top: 10px;z-index:99999"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                                                    @endif
