...
/**
 * Description of MethodController
 *
 * @author User
 */
class MethodController extends Controller {
    ...
    //put your code here
    protected $MY_Model;
    protected $table_default = 'tbl_master_methods';
    ...
    public function create(Request $request) {
        ...
        $_breadcrumbs = [
            ...
            [
                ...
                'icon' => '',
                'arrow' => true,
                'path' => config('app.base_extraweb_uri') . '/master/method/view'
            ],
            [
                'id' => 3,
                'title' => 'Method create new',
                'icon' => '',
                'arrow' => false,
                'path' => '#'
            ]
        ...
        $_config = [
            'title_for_header' => 'Create new <b>Method</b> master data management page',
            'create_page' => [
                'title' => 'click to open method list page',
                'icon' => '<i class="fa-solid fa-list"></i>',
                'link' => config('app.base_extraweb_uri') . '/master/method/view'
            ]
        ];
    ...
    public function edit(Request $request, $pr_id = null) {
        ...
        $_config = [
            'title_for_header' => 'Update <b>Method</b> master data management page',
            'create_page' => [
                'title' => 'click to open method list page',
                'icon' => '<i class="fa-solid fa-list"></i>',
                'link' => config('app.base_extraweb_uri') . '/master/method/view'
        ...
        $method = $this->MY_Model->find($request, 'first', $params);
        return view('Public_html.Layouts.Adminlte.dashboard', compact('title_for_layout', '_breadcrumbs', '_config', 'method'));
    }
    ...
    public function view(Request $request) {
        ...
        $_config = [
            'title_for_header' => '<b>Method</b> master data management page',
            'create_page' => [
                'title' => 'click to open form create new method',
                'icon' => '<i class="fas fa-square-plus"></i>',
                'link' => config('app.base_extraweb_uri') . '/master/method/create'
            ]
        ];
        return view('Public_html.Layouts.Adminlte.dashboard', compact('title_for_layout', '_breadcrumbs', '_config'));
    }
            ...
            if (isset($data['data']) && !empty($data['data'])) {
                ...
                foreach ($data['data'] AS $keyword => $value) {
                    ...
                    $arrData[] = [
                        ...
                        <button type="button" class="btn btn-info"><a href="' . config('app.base_extraweb_uri') . '/master/method/edit/' . base64_encode($value->id) . '" style="color:#fff;font-size:14px;" title="Edit"><i class="fas fa-edit"></i></a></button>
                        <button type="button" class="btn btn-info"><a href="' . config('app.base_extraweb_uri') . '/master/method/remove/' . base64_encode($value->id) . '" style="color:#fff;font-size:14px;" title="Remove"><i class="fas fa-xmark"></i></a></button>
                        <button type="button" class="btn btn-info"><a href="' . config('app.base_extraweb_uri') . '/master/method/delete/' . base64_encode($value->id) . '" style="color:#fff;font-size:14px;" title="Add"><i class="far fa-trash-alt"></i></a></button>
                      </div>',
                    ];
