...
class Tbl_a_menus extends MY_Model {
    ...
    public function get_menus($group_id, $level, $parent_id) {
    ...
    public function get_menus2($level, $parent_id) {
        return DB::table(self::$table_name . ' AS a')
                        ->select('a.id', 'a.name', 'a.icon', 'a.path', 'a.badge', 'a.badge_id', 'a.badge_value', 'a.level', 'a.rank', 'a.parent_id', 'a.is_badge', 'a.is_open', 'a.is_active')
                        ->where([['a.level', '=', $level], ['a.parent_id', '=', $parent_id]])
                        ->orderBy('a.rank', 'ASC')
                        ->get();
    }
    ...
    public function get_menu_by_parent_id($module_id, $level, $parent_id) {
        return DB::table(self::$table_name . ' AS a')
    ...
    public function get_menu_by_level($id) {
        return DB::table(self::$table_name . ' AS a')
    ...
    public function get_tree_menu($request, $__group_id, $__module_id) {
        $menu = [];
