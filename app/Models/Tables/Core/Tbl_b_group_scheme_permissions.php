...
/**
 * Description of Tbl_b_group_scheme_permissions
 *
 * @author User
 */
class Tbl_b_group_scheme_permissions extends MY_Model {

    //put your code here  
    public static $table_name = "tbl_b_group_scheme_permissions";
